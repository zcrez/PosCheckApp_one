...
namespace PosCheckApp
{
    public partial class MainMap : Form
    {
       ...
       public List<string> m_initphotofiles = new List<string>();


        public static MainMap instance = null;
        public  string g_imagePath;
        public string g_posFilePath;

        public string g_projName;
        ...
        private void PosImport_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                ...
                return;
            ReadPosFile(strFileName);
        }

         public int ReadPosFile(string posfilepath)
         {

             StreamReader sr = new StreamReader(posfilepath, Encoding.Default);
             String line;
             int i = 0;
        ...
        public void RefreshMapByPos()
        {
            if (m_ppts.Count > 0)  //在地图上标示pos点位置
            {
                ...
                PointLatLng center = rout.GetCenterPoint();
        ...
        /// <param name="e"></param>
        private void menubtn_posCheck_Click(object sender, EventArgs e)
        {
